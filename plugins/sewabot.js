...
let handler = async(m, { conn }) => {
	...
	conn.p[id] = [
	await conn.sendKontak(m.chat, kontakseller, fkontak, { contexInfo: { forwardingScore: 99999, isForwarded: true } })
	]
	await delay(100)
  return conn.sendMessage(m.chat, { text: `Hay kak @${await m.sender.split('@')[0]}, Itu Adalah Seller Kepercayaan Bot Kami.\nJika Kamu Ingin Sewa Bot Silahkan Hubungi Salah Satu Seller Kami.\n\nTerima Kasih.`, mentions: [m.sender] }, { quoted: conn.p[id][0] })
  await delay(100)
