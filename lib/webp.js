...
class Image {
  ...
  demuxAnim(path, frame = -1, prefix = '#FNAME#') {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (let i = start; i <= end; i++) {
        yield _classPrivateMethodGet(_this2, _demuxFrame, _demuxFrame2).call(_this2, `${path}/${prefix}_${i}.webp`.replace(/#FNAME#/g, (0, _path.basename)(_this2.path, '.webp')), _this2.anim.frames[i])
      }
    })()
  }
  ...
  static muxAnim({ path, frames, width = 0, height = 0, bgColor = [255, 255, 255, 255], loops = 0, delay = 100, x = 0, y = 0, blend = true, dispose = false } = {}) {
    return _asyncToGenerator(function* () {
...
var _readChunk_ANMF2 = /*#__PURE__*/ (function () {
  var _readChunk_ANMF3 = _asyncToGenerator(function* (fd, size) {
    ...
    while (keepLooping) {
      let header = _classPrivateMethodGet(this, _readChunkHeader_buf, _readChunkHeader_buf2).call(this, buf, cursor),
        t
...
var _read2 = /*#__PURE__*/ (function () {
  var _read3 = _asyncToGenerator(function* (path) {
    ...
    while (keepLooping) {
      let { fourCC, size } = yield _classPrivateMethodGet(this, _readChunkHeader, _readChunkHeader2).call(this, fd)
      ...
      switch (fourCC) {
        ...
        case 'ANIM':
          if (!out.anim) {
            let { raw, bgColor, loopCount } = yield _classPrivateMethodGet(this, _readChunk_ANIM, _readChunk_ANIM2).call(this, fd, size)
            out.anim = {
        ...
        case 'ANMF':
          {
            let f = yield _classPrivateMethodGet(this, _readChunk_ANMF, _readChunk_ANMF2).call(this, fd, size)
